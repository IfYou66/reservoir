...
public class SysUserController extends BaseController
{
    ...
    public R<LoginUser> info(@PathVariable("username") String username)
    {
        ...
        sysUserVo.setfReservoirInfoId(sysUser.getfReservoirInfoId());//水库ID
    ...
    /**
     * 后台系统添加默认系统用户-非前端页面调用
     */
    @PostMapping("addDefaultUser")
    public R<SysUser> addDefaultUser(@Validated @RequestBody SysUser user)
    {
        ...
        return R.ok(userService.insertDefaultUser(user));
    }
