      ...
      <el-col :span="24">
        <div style="margin: 0 auto;display: flex;align-items: center;width: 100%;justify-content:center;">
          ...
          <div  style="position: relative;">
            ...
            <div  :style="active>1? 'position: absolute;top: 10px;left: 100px;width: 50%;color: #FFFFFF;':'position: absolute;top: 10px;left: 100px;width: 50%;color: #757575;'">2.应急响应</div>
            </div>
          <div   style="position: relative;">
            <img :src="require(active>2? '../../../assets/images/jin.png':'../../../assets/images/jin1.png')" />
            <div  :style="active>2? 'position: absolute;top: 10px;left: 100px;width: 50%;color: #FFFFFF;':'position: absolute;top: 10px;left: 100px;width: 50%;color: #757575;'">3.险情排除</div>
            </div>
            <div   style="position: relative;">
              <img :src="require(active==4? '../../../assets/images/jin.png':'../../../assets/images/jin1.png')" />
              <div  :style="active==4? 'position: absolute;top: 10px;left: 100px;width: 50%;color: #FFFFFF;':'position: absolute;top: 10px;left: 100px;width: 50%;color: #757575;'">4.处置检查完成</div>
              </div>
        </div>
      </el-col>
    </el-row>
    ...
    <div  class="from-div">
      ...
      <el-row class="from-border-bottom" >
        ...
        <el-col :span="4" class="from-border-right" >
          <el-input v-model="MRiskManagement.fRiskName" placeholder="请输入内容"></el-input>
        </el-col>

        <el-col :span="2" class="from-col-left" >  险情类别 </el-col>
        <el-col :span="3" style="line-height: 40px;border-right: #a4d5ff 1px solid;">
            <div>
              <el-select v-model="MRiskManagement.fRiskType" placeholder="请选择">
        ...
        <el-col :span="2" class="from-border-right" >
          <el-input v-model="MRiskManagement.fRiskNumber" placeholder="请输入内容"></el-input>
        </el-col>
            ...
            <div style="font-size: 20px;margin-right: 10px;margin-top: -5px;">
              <div style="text-align: left">
                <div style="display:inline;margin-right: -15px">记录人：
                  <el-input v-model="MRiskManagement.fRecordPeople" placeholder="请输入内容"
                ...
                <div class="block" style="transform:translateY(10%)">
                  ...
                  <el-date-picker
                    ...
                    v-model="MRiskManagement.fRecordDate"
                    placeholder="选择日期"
                    format="yyyy-MM-dd"
      ...
      <el-row  class="from-border-bottom" >
        ...
        <el-col :span="21" >
          ...
          <el-input maxlength="500" show-word-limit  type="textarea" :rows="5" placeholder="请输入内容" v-model="MRiskManagement.fResponseSituation" :disabled="true">
          </el-input>
            ...
            <div style="font-size: 20px;margin-right: 10px;margin-top: -5px;">
              <div style="text-align: left">
                ...
                <div class="block" style="transform:translateY(10%)">
                  <span class="demonstration" v-html="'时&ensp;&ensp;间：'"/>
                  <el-date-picker
                    type="dates" style="border: 1px solid #DCDFE6;"
                    v-model="MRiskManagement.fResponseDate"
                    placeholder="选择日期"
      ...
      <el-row  class="from-border-bottom" >
        ...
        <el-col :span="21" >
          ...
          <el-input maxlength="500" show-word-limit  type="textarea" :rows="5" placeholder="请输入内容" v-model="MRiskManagement.fDisposalResults" :disabled="true">
          </el-input>
            ...
            <div style="font-size: 20px;margin-right: 10px;margin-top: -5px;">
              <div style="text-align: left">
                ...
                <div class="block" style="transform:translateY(10%)">
                  ...
                  <el-date-picker
                    type="dates" style="border: 1px solid #DCDFE6;"
                    v-model="MRiskManagement.fDisposalDate"
                    placeholder="选择日期"
                    format="yyyy 年 MM 月 dd 日"
                    value-format="yyyy-MM-dd HH:mm:ss"
                    :disabled="true">
      ...
      <el-row class="from-border-bottom">
        ...
        <el-col :span="21" style="height: 50px;">
          ...
          <el-input maxlength="500" show-word-limit  type="textarea" placeholder="请输入内容" :rows="2" v-model="MRiskManagement.fInspectionOpinions" :disabled="true"> </el-input>

          <div style="display: inline">
            <div style="margin-left: 10px;margin-top: 15px">
              <span style="font-size: 16px;font-weight: 700;display:inline;"> 检查结果： </span>
              <el-select v-model="MRiskManagement.fInspectionResults" clearable placeholder="请选择" style="border: 1px solid #DCDFE6;" :disabled="true">
                <el-option v-for="item in audit" :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
                </el-option>
              </el-select>
            </div>
            ...
            <div  style="text-align:right;margin-right: 15px;margin-top: -37px">
              <span >检查人：<el-input v-model="MRiskManagement.fInspectionPeople" placeholder="请输入内容" style="width:180px;border: 1px solid #DCDFE6;" :disabled="true"></el-input></span>
              <div class="block"  style="display:inline;margin-left:10px;">
                <span class="demonstration" v-html="'时&ensp;&ensp;间：'"/>
                <el-date-picker style="border: 1px solid #DCDFE6;"
                  type="dates"
                  v-model="MRiskManagement.fInspectionDate"
                  placeholder="选择日期"
                  format="yyyy 年 MM 月 dd 日"
                  value-format="yyyy-MM-dd HH:mm:ss"
                  :disabled="true">
  ...
  export default {
    ...
    methods: {
      ...
      handleRemove(file, fileList) {
        this.GLOBAL.commonFun(this.MRiskManagement.fRiskInfoFileId);
      },
      //删除文件的
      ...
      //保存按钮
      save() {
        this.MRiskManagement.fActStatus = 0
        addManagement(this.MRiskManagement).then(res => {
          if(res.code == 200) {
      ...
      addsubmit() {
        //是否填写 险情名称
        if(this.MRiskManagement.fRiskName == null || this.MRiskManagement.fRiskName == '') {
          this.$message({
            showClose: true,
            message: '请填写险情名称',
            type: 'error'
        ...
        //是否填写 险情类别
        if(this.MRiskManagement.fRiskType == null || this.MRiskManagement.fRiskType == '') {
          this.$message({
            showClose: true,
            message: '请选择险情类别',
            type: 'error'
        ...
        //是否填写 险情编号
        if(this.MRiskManagement.fRiskNumber == null || this.MRiskManagement.fRiskNumber == '') {
          this.$message({
            showClose: true,
            message: '请填写险情编号',
            type: 'error'
        ...
        //是否填写 险情发现时间
        if(this.MRiskManagement.fRiskFindDate == null || this.MRiskManagement.fRiskFindDate == '') {
          this.$message({
            showClose: true,
            message: '请选择险情发现时间',
            type: 'error'
        ...
        //是否填写 险情概述
        if(this.MRiskManagement.fRiskSummary == null || this.MRiskManagement.fRiskSummary == '') {
          this.$message({
            showClose: true,
            message: '请填写险情概述',
            type: 'error'
        ...
        //是否填写 记录人
        if(this.MRiskManagement.fRecordPeople == null || this.MRiskManagement.fRecordPeople == '') {
          this.$message({
            showClose: true,
            message: '请填写记录人',
            type: 'error'
        ...
        //是否填写 记录时间
        if(this.MRiskManagement.fRecordDate == null || this.MRiskManagement.fRecordDate == '') {
          this.$message({
            showClose: true,
            message: '请选择记录时间',
            type: 'error'
      ...
      //测试接口
      test() {
        listManagement({pageNum:1, pageSize:10}).then(res => {
