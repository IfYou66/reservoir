function getMenu() {
    return [
        {href: "page/special/mahe/introduction.html", icon: 'layui-icon-list', name: '全景图', sub: []},
            ...
            href: "", icon: 'layui-icon-app', name: '常规监测', sub: [
                ...
                {href: "page/inspect/manual_check.html", icon: '', name: '人工校核', sub: []},
                {
                    href: "", icon: '', name: '巡检管理', sub: [
                        {href: "page/inspect/manual_inspect.html", icon: '', name: '人工巡检', sub: []},
                        
                        {href: "page/inspect/flight_inspect.html", icon: '', name: '无人机巡检', sub: []},
                    ]
                }
            ]
        },
            ...
            href: "", icon: 'layui-icon-link', name: '安全监测', sub: [
                ...
                },
                {
                    href: "page/inspect/history_data.html", icon: '', name: '溢洪闸安全', sub: [
                        ...
                        {href: "page/safe/gate_seepage.html", icon: '', name: '扬压力及渗流', sub: []},
                        {href: "page/safe/gate_vibration.html", icon: '', name: '闸体振动监测', sub: []},
                    ]
                },
                {
                    href: "", icon: '', name: '放水洞安全', sub: [
                        {href: "page/safe/tunnel_vibration.html", icon: '', name: '振动监测', sub: []},
                        {href: "page/safe/tunnel_seepage.html", icon: '', name: '实时渗流', sub: []},
                    ]
                }
            ]
        },
        ...
        },
        {
            href: "", icon: 'layui-icon-water', name: '洪水预报', sub: [
                {href: "page/flood/control_basin.html", icon: '', name: '控制流域与雨量分布', sub: []},
                {href: "page/flood/flood.html", icon: '', name: '入库洪水分析', sub: []},
                {href: "page/flood/flood_control.html", icon: '', name: '水库调洪预算', sub: []},
                {href: "page/flood/drown_analysis.html", icon: '', name: '下游淹没分析', sub: []},
                {href: "page/flood/retain_analysis.html", icon: '', name: '下闸蓄水时刻分析', sub: []},
            ]
        },
        {
            href: "", icon: 'layui-icon-util', name: '供水调度', sub: [
                {href: "page/supply/industry.html", icon: '', name: '工业供水', sub: []},
                {href: "page/supply/city.html", icon: '', name: '城市供水', sub: []},
                {href: "page/supply/agriculture.html", icon: '', name: '农业灌溉', sub: []},
                {href: "page/supply/ecology.html", icon: '', name: '生态供水', sub: []},
            ]
        },
        {href: "page/template/error/error-402.html", icon: 'layui-icon-camera', name: '视频监控', sub: []},
        {
            href: "", icon: 'layui-icon-read', name: '电子档案', sub: [
                {href: "page/document/register.html", icon: '', name: '注册登记表', sub: []},
                {href: "page/document/archive.html", icon: '', name: '历史档案', sub: []},
