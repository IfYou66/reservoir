      ...
      <!-- <el-col :span="24">
        <div style="margin: 0 auto;display: flex;align-items: center;width: 100%;justify-content:center;">
          <div style="position: relative;">
            ...
            <div  style="position: absolute;top: 27px;left: 23px;width: 50%;color: #FFFFFF;">申请</div>
          </div>
      ...
      <el-col :span="24">
        <div style="margin: 0 auto;display: flex;align-items: center;width: 100%;justify-content:center;">
          <div style="position: relative;">
            ...
            <div style="position: absolute;top: 10px;left: 100px;width: 50%;color: #FFFFFF;">1.申请</div>
          </div>
          <div style="position: relative;">
          ...
          <div style="position: relative;">
            ...
            <div
              :style="active==4? 'position: absolute;top: 10px;left: 100px;width: 50%;color: #FFFFFF;':'position: absolute;top: 10px;left: 100px;width: 50%;color: #757575;'">
              4.完成
            </div>
          </div>
    ...
    <div class="from-div">
      ...
      <el-row class="from-border-bottom">
        ...
        <el-col :span="8" class="from-border-right">
          <el-input v-model="formData.fApplyName" clearable placeholder="请输入内容"
        ...
        <el-col :span="4" class="from-border-right">
          <el-input v-model="formData.fApplyMoney" clearable placeholder="请输入内容"
                    v-bind:disabled="active != 1? true : false"></el-input>
        </el-col>
      </el-row>
      ...
      <el-row class="from-border-bottom">
        ...
        <el-col :span="21" style="height: 400px;">
          ...
          <el-input type="textarea"   maxlength="500" show-word-limit :rows="8" placeholder="请输入内容" v-model="formData.fPurpose"
                    v-bind:disabled="active != 1? true : false">
          </el-input>
          <div style="display:flex;justify-content:space-between;margin-top: 70px;">
            <div style="width: 200px;margin-left: 20px;">
              <el-upload style="margin-left: 15px;" class="upload-demo"
                ...
                <el-button size="small" type="primary" :disabled="active != 1">经费用途</el-button>
                               <div slot="tip" class="el-upload__tip" style="margin-top: 15px">上传文件不得超过100M</div>
              </el-upload>
            </div>
            <div style="font-size: 20px;margin-right: -5px;width:300px;">
              <div style="text-align: left;transform:translateY(-10%);">
                <div style="margin-left:-20px;display:inline;">编制人：
                  <el-input v-model="formData.fPreparedBy" placeholder="请输入内容"
                            style="margin-left:-1px;width:220px;border: 1px solid #DCDFE6;"
                            v-bind:disabled="active != 1? true : false"></el-input>
                </div>
                <div class="block" style="transform:translateY(10%);margin-left: -20px">
                  <span class="demonstration" v-html="'时&ensp;&ensp;间：'"/>
                  <el-date-picker style="border: 1px solid #DCDFE6;margin-left: 5px"
                                  type="date"
      ...
      <el-row class="from-border-bottom">
        ...
        <el-col :span="21" style="height: 50px;">
          ...
          <div class="from-select">
            ...
            <div>
              <span>审核人：<el-input v-model="formData.fReviewPeople" placeholder="请输入内容" style="width:180px;"
                                  v-bind:disabled="active != 2? true : false"></el-input></span>
      ...
      <el-row class="from-border-bottom">
        ...
        <el-col :span="21" style="height: 50px;">
          ...
          <div class="from-select">
            ...
            <div>
              <span>审批人：<el-input v-model="formData.fAuditPeople" placeholder="请输入内容" style="width:180px;"
                                  v-bind:disabled="active != 3? true : false"></el-input></span>
              <div class="block" style="display:inline;margin-left:10px;">
                <span class="demonstration" v-html="'时&ensp;&ensp;间：'"/>
                <el-date-picker
                  type="date"
...
import {addApply, updateApply, inquiry} from "@/api/fundManage/apply"
...
export default {
  ...
  methods: {
    ...
    submit(type) {
      if (this.active == 1) {
        if (this.formData.fApplyName == null) {
          ...
          return false
        } else if (this.formData.fApplyFileId == null) {
    ...
    addAndUpdate() {
      ...
      if (this.formData.fId != null && this.formData.fId != '') {
        ...
        addApply(this.formData).then(res => {
          if (res.code == 200) {
            if (this.formData.holdOrSubmit == 1) {
              this.$message.success("经费申请提交成功");
            } else {
              this.msgSuccess("经费申请暂存成功")
            }
            this.clearForm();
            // this.dialogVisible = false
          } else {
            if (this.formData.holdOrSubmit == 1) {
              this.$message.error("经费申请提交失败");
            } else {
              this.msgError("经费申请暂存失败")
            }
          }
        });
      }
    ...
    uploadedSuccess(response, file, fileList) {
      this.formData.fApplyFileId = response.data.fId
      this.fileList = [{
    ...
    handleRemove(file, fileList) {
      this.GLOBAL.commonFun(this.formData.fApplyFileId)
    },
    handlePreview(file) {
