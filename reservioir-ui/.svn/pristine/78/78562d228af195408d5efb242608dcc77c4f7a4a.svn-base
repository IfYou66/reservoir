<template>
  <div class="app-container">
     <el-row class="from-top">
      <!-- <el-col :span="24">
        <el-steps :active="1" simple>
          ...
          <el-step title="出库完成" icon="el-icon-picture"></el-step>
        </el-steps>
      </el-col> -->
      <el-col :span="24">
        <div style="margin: 0 auto;display: flex;align-items: center;justify-content:center;width: 80% ;">
          ...
          <div   style="position: relative;">
            ...
            <div   style="position: relative;">
              ...
              <div  :style="active>1? 'position: absolute;top: 17px;left: 23px;width: 50%;color: #FFFFFF;':'position: absolute;top: 17px;left: 23px;width: 50%;color: #999999;'">出库完成</div>
              </div>
        </div>
      </el-col>
    </el-row>
    <div  class="from-div">
      ...
      <el-row>
        <el-col :span="24"
        class="from-div-title">物资出库审批表</el-col>
      </el-row>
      ...
      <el-row class="from-border-bottom">
        ...
        <el-col :span="21" style="height: 50px;">
          ...
          <el-input maxlength="500" show-word-limit  type="textarea" :rows="3" v-model="textarea"   placeholder="请输入内容">
            ...
            <div style="text-align:right">
              <span >出库人：<el-input v-model="input"  placeholder="请输入内容" style="width:180px;"></el-input></span>
              <div class="block"  style="display:inline;margin-left:10px;">
                <span class="demonstration">时间：</span>
                <el-date-picker
                  type="dates"
      ...
      <el-table v-loading="loading" :data="data" border>
        ...
        <el-table-column label="出库人" align="center" prop="status" />
