      ...
      <el-col :span="24">
        <div style="margin: 0 auto;display: flex;align-items: center;width: 100%;justify-content:center;">
          ...
          <div  style="position: relative;">
            ...
            <div  :style="active>=1? 'position: absolute;top: 10px;left: 100px;width: 50%;color: #FFFFFF;':'position: absolute;top: 10px;left: 100px;width: 50%;color: #757575;'">2.计划审核</div>
          </div>
          <!-- 计划批准 -->
          <div   style="position: relative;">
            <img :src="require(active>=2? '../../../assets/images/jin.png':'../../../assets/images/jin1.png')" />
            <div  :style="active>=2? 'position: absolute;top: 10px;left: 100px;width: 50%;color: #FFFFFF;':'position: absolute;top: 10px;left: 100px;width: 50%;color: #757575;'">3.计划批准</div>
          </div>
          <!-- 计划完成 -->
          <div   style="position: relative;">
            <img :src="require(active==3? '../../../assets/images/jin.png':'../../../assets/images/jin1.png')" />
            <div  :style="active==3? 'position: absolute;top: 10px;left: 100px;width: 50%;color: #FFFFFF;':'position: absolute;top: 10px;left: 100px;width: 50%;color: #757575;'">4.计划完成</div>
          </div>
    ...
    <div  class="from-div">
      ...
      <el-row class="from-border-bottom" >
        ...
        <el-col :span="8" class="from-border-right" >
          <el-input v-model="rMaintenance.fPlanName" placeholder="请输入内容"></el-input>
        </el-col>

        <el-col :span="3" class="from-col-left" > 计划类型 </el-col>
        <el-col :span="3" style="line-height: 40px;border-right: #a4d5ff 1px solid;">
            <div>
              <el-select v-model="rMaintenance.fPlanType" placeholder="请选择">
        ...
        <el-col :span="4" class="from-border-right" >
          <el-input v-model="rMaintenance.fBudget" placeholder="预算（元）"></el-input>
        </el-col>
      ...
      <el-row  class="from-border-bottom">
        ...
        <el-col :span="21" style="height: 400px;">
          ...
          <el-input type="textarea" maxlength="500" show-word-limit  :rows="8" placeholder="请输入内容" v-model="rMaintenance.fPlanContent"> </el-input>
          ...
          <div style="font-size: 20px;margin-right: 10px;margin-top: -10px;">
            <div style="text-align: left">
             <div style="display:inline;">编制人：<el-input v-model="rMaintenance.fPreparedBy"  placeholder="请输入编制人名称" style="width:220px;border: 1px solid #DCDFE6;"></el-input></div>
      ...
      <el-row class="from-border-bottom">
        ...
        <el-col :span="21" style="height: 50px;">
          ...
          v-model="rMaintenance.fReviewComments" :disabled="true"> </el-input>
          ...
          <div class="from-select">
            ...
            <div>
              ...
              placeholder="请输入内容" style="width:180px;" :disabled="true"></el-input></span>
              <div class="block"  style="display:inline;margin-left:10px;">
                <span class="demonstration" v-html="'时&ensp;&ensp;间：'"/>
                <el-date-picker
                  type="rMaintenance.fReviewDate"
      ...
      <el-row class="from-border-bottom">
        ...
        <el-col :span="21" style="height: 50px;">
          ...
          v-model="rMaintenance.fAuditComments" :disabled="true">
          </el-input>
          <div class="from-select">
            <div style="margin-left: 10px;">
              <div style="font-size: 16px;font-weight: 700;display:inline;"> 审批结果： </div>
              <el-select v-model="rMaintenance.fAuditResult" clearable placeholder="请选择" :disabled="true">
                <el-option v-for="item in audit" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </div>
...
export default {
    ...
    methods: {
      ...
      handleRemove(file, fileList) {
        this.GLOBAL.commonFun(this.rMaintenance.fPlanId);
      },
      //删除文件的
      ...
      addSubmits() {
        ...
        this.rMaintenance.fStatus = 1
        this.rMaintenance.fActPersion = this.radio
        addMaintenance(this.rMaintenance).then(res => {
          if(res.code == 200) {
            this.msgSuccess("提交成功")
            this.nextVisible = false
